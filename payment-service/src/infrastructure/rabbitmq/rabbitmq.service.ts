...
export class RabbitMQService implements OnModuleInit, OnModuleDestroy {
  ...
  private async setupConsumers() {
    // Consumer for payment required events
    await this.channel.consume('payment.required', async (msg) => {
      if (msg) {
        const content = JSON.parse(msg.content.toString());
        console.log('Payment required for reservation:', content.reservationId);
